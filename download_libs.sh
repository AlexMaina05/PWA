...
curl -L -o libs/argon2.min.js https://cdn.jsdelivr.net/npm/argon2-browser/dist/argon2.min.js

echo "Downloading argon2 WASM..."
curl -L -o libs/argon2.wasm https://cdn.jsdelivr.net/npm/argon2-browser/dist/argon2.wasm
